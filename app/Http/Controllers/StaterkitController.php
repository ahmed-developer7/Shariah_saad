...
class StaterkitController extends Controller
{
    ...
    public function collapsed_menu()
    {
        ...
        $breadcrumbs = [
            ['link' => "admin/home", 'name' => "Home"], ['link' => "javascript:void(0)", 'name' => "Layouts"], ['name' => "Collapsed menu"]
        ];
    ...
    public function layout_full()
    {
        ...
        $breadcrumbs = [
            ['link' => "admin/home", 'name' => "Home"], ['name' => "Layouts"], ['name' => "Layout Full"]
        ];
    ...
    public function without_menu()
    {
        ...
        $breadcrumbs = [
            ['link' => "admin/home", 'name' => "Home"], ['link' => "javascript:void(0)", 'name' => "Layouts"], ['name' => "Layout without menu"]
        ];
    ...
    {
        $breadcrumbs = [['link' => "admin/home", 'name' => "Home"], ['link' => "javascript:void(0)", 'name' => "Layouts"], ['name' => "Layout Empty"]];
